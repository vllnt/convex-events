...
`@vllnt/convex-events` is a Convex component: Append-only per-subject activity feed and event ledger, as a Convex component It follows the vllnt Component
...
├── client/
│   ├── index.ts           # Events client class (consumer-facing API)
