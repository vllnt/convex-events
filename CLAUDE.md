...
| `llms-full.txt` | generated by `pnpm generate:llms` — regenerate on every API/schema/README change |
...
Run `pnpm generate:llms` after any source, README, or API.md change. Grep stale values before
committing (see `.claude/rules/docs-sync.md`).
